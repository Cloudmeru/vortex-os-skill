# image-cover plugin — cover art generation (stub: 1x1 PNG)
[CmdletBinding()]
param()
...
Write-VortexPluginLog "image-cover invoked: prompt_len=$($inputs.prompt.Length)"
...
Write-VortexPluginOutput @{ file = $outFile; width = 1; height = 1 }
